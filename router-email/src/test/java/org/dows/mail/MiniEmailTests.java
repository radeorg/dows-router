...
public class MiniEmailTests {
    // 该邮箱修改为你需要测试的收件邮箱地址
    private static final String TO_EMAIL = "137xxxxxx79@163.com";
    // 发送邮件给多个收件人
    private static final String[] TO_EMAILS = new String[]{"282785755@qq.com", "137xxxxxx79@163.com"};
    ...
    public void before() {
        // 创建工厂类 详细版
        miniEmailFactory = new MiniEmailFactoryBuilder().build(MailConfig.config("282785755@qq.com", "abcdefg")
                .setMailDebug(Boolean.FALSE)
                .setSenderNickname("lait")
                .setMailSmtpSslEnable(Boolean.TRUE)
                .setSmtpHost(SmtpHostEnum.SMTP_QQ.getSmtpHost())
                .setSmtpPort(SmtpHostEnum.SMTP_QQ.getSmtpPort())
        );
        // 创建工厂类：简洁版
//        miniEmailFactory = new MiniEmailFactoryBuilder().build(Boolean.FALSE, "1846316024@qq.com", "abcdefg", SmtpHostEnum.SMTP_QQ);
    }
    ...
    public void testSendText() {
        ...
        List<String> sendSuccessToList = miniEmail
                ...
                .send(TO_EMAILS, "这是来自 email 的测试信文本内容");
    ...
    public void testSendHtml() {
        ...
        List<String> sendSuccessToList = miniEmail
                ...
                .send(TO_EMAILS, "HTML邮件主题", EmailContentTypeEnum.HTML, "<h1 style='color:red;'>这是来自 email 的测试 HTML 内容</h1>");
        System.out.println("send success to = " + sendSuccessToList);
    }
    ...
    public void testSendAttachFileAndURL() throws MalformedURLException {
        ...
        MiniEmail miniEmail = miniEmailFactory.init();
        List<String> sendSuccessToList = miniEmail
                .addCarbonCopy(new String[]{"282785755@qq.com"})
                .addBlindCarbonCopy(new String[]{TO_EMAIL})
                .addAttachment(file, "666.jpg")
                .addAttachment(url, "888.jpg")
                .send(TO_EMAILS, "致我们失去的青春", EmailContentTypeEnum.HTML, "<h2 style='color:blue;'>这是来自 email 的测试 HTML 内容</h2><br /><h2 style='color:red;'>请查看附件内容</h2>");
