...
import org.dows.email.builder.EmailSessionBuilder;
...
public class DefaultMiniEmailFactory implements MiniEmailFactory {
    private static final Logger log = LoggerFactory.getLogger(DefaultMiniEmailFactory.class);
    ...
    private String constructFinalSenderName(String senderNickname, String username) {
        ...
        try {
            ...
            log.warn("senderNickname 解析失败，重新使用 username 作为发件人别名", e);
        }
